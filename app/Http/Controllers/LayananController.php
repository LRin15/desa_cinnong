...
class LayananController extends Controller
{
     ...
     * karena nama di KTP bisa berbeda dari nama akun.
     */
    ...
    /**
     * Data user yang login — dikirim ke setiap halaman form
     * agar frontend bisa menampilkan info akun & pre-fill nama.
     */
    ...
    public function kelahiran()
    {
        $fields = [
            ...
            ['name' => 'jenis_kelamin_bayi', 'label' => 'Jenis Kelamin Bayi',      'type' => 'select', 'required' => true, 'options' => ['Laki-laki', 'Perempuan']],
            ['name' => 'tempat_lahir_bayi',  'label' => 'Tempat Lahir Bayi',       'type' => 'text',   'required' => true],
            ['name' => 'tanggal_lahir_bayi', 'label' => 'Tanggal Lahir Bayi',      'type' => 'date',   'required' => true],
            ['name' => 'jam_lahir',          'label' => 'Jam Lahir',               'type' => 'text',   'required' => true, 'placeholder' => 'HH:MM (contoh: 14:30)'],
            ['name' => 'berat_bayi',         'label' => 'Berat Bayi (gram)',        'type' => 'text',   'required' => true, 'placeholder' => 'Contoh: 3200'],
            ['name' => 'panjang_bayi',       'label' => 'Panjang Bayi (cm)',        'type' => 'text',   'required' => true, 'placeholder' => 'Contoh: 50'],
            // Data Ayah
            ['name' => 'nama_ayah',     'label' => 'Nama Ayah',     'type' => 'text', 'required' => true],
            ['name' => 'nik_ayah',      'label' => 'NIK Ayah',      'type' => 'text', 'required' => true, 'maxLength' => 16],
            ['name' => 'pekerjaan_ayah','label' => 'Pekerjaan Ayah','type' => 'text', 'required' => true],
            // Data Ibu
            ['name' => 'nama_ibu',      'label' => 'Nama Ibu',      'type' => 'text', 'required' => true],
            ['name' => 'nik_ibu',       'label' => 'NIK Ibu',       'type' => 'text', 'required' => true, 'maxLength' => 16],
            ['name' => 'pekerjaan_ibu', 'label' => 'Pekerjaan Ibu', 'type' => 'text', 'required' => true],
            // Alamat & Kontak
            ['name' => 'alamat',     'label' => 'Alamat Lengkap', 'type' => 'textarea', 'required' => true, 'rows' => 3],
            ['name' => 'rt',         'label' => 'RT',             'type' => 'text',     'required' => true, 'maxLength' => 3],
            ['name' => 'rw',         'label' => 'RW',             'type' => 'text',     'required' => true, 'maxLength' => 3],
            ['name' => 'no_telepon', 'label' => 'No. Telepon',    'type' => 'tel',      'required' => true, 'placeholder' => '08xxxxxxxxxx'],
            // Upload Dokumen
            ['name' => 'foto_ktp_ayah',        'label' => 'Upload Fotocopy KTP Ayah',                        'type' => 'file', 'required' => true,  'accept' => 'image/*,.pdf'],
            ['name' => 'foto_ktp_ibu',         'label' => 'Upload Fotocopy KTP Ibu',                         'type' => 'file', 'required' => true,  'accept' => 'image/*,.pdf'],
            ['name' => 'foto_kk',              'label' => 'Upload Fotocopy KK',                              'type' => 'file', 'required' => true,  'accept' => 'image/*,.pdf'],
            ['name' => 'foto_buku_nikah',      'label' => 'Upload Fotocopy Buku Nikah',                      'type' => 'file', 'required' => true,  'accept' => 'image/*,.pdf'],
            ['name' => 'surat_keterangan_lahir','label' => 'Upload Surat Keterangan Kelahiran dari Bidan/RS', 'type' => 'file', 'required' => true,  'accept' => 'image/*,.pdf'],
        ];
    ...
    public function kematian()
    {
        $fields = [
            ...
            ['name' => 'nik_almarhum',           'label' => 'NIK Almarhum/Almarhumah',     'type' => 'text',     'required' => true, 'maxLength' => 16],
            ['name' => 'jenis_kelamin_almarhum', 'label' => 'Jenis Kelamin',               'type' => 'select',   'required' => true, 'options' => ['Laki-laki', 'Perempuan']],
            ['name' => 'tempat_lahir_almarhum',  'label' => 'Tempat Lahir',                'type' => 'text',     'required' => true],
            ['name' => 'tanggal_lahir_almarhum', 'label' => 'Tanggal Lahir',               'type' => 'date',     'required' => true],
            ['name' => 'tanggal_kematian',       'label' => 'Tanggal Kematian',            'type' => 'date',     'required' => true],
            ['name' => 'jam_kematian',           'label' => 'Jam Kematian',                'type' => 'text',     'required' => true, 'placeholder' => 'HH:MM (contoh: 14:30)'],
            ['name' => 'tempat_kematian',        'label' => 'Tempat Kematian',             'type' => 'text',     'required' => true, 'placeholder' => 'Contoh: RS, Rumah, dll'],
            ['name' => 'sebab_kematian',         'label' => 'Sebab Kematian',              'type' => 'textarea', 'required' => true, 'rows' => 3],
            // Data Pelapor
            ['name' => 'nama_pelapor',     'label' => 'Nama Pelapor',                           'type' => 'text',     'required' => true],
            ['name' => 'nik_pelapor',      'label' => 'NIK Pelapor',                            'type' => 'text',     'required' => true, 'maxLength' => 16],
            ['name' => 'hubungan_pelapor', 'label' => 'Hubungan dengan Almarhum/Almarhumah',    'type' => 'text',     'required' => true, 'placeholder' => 'Contoh: Anak, Istri, Suami, dll'],
            ['name' => 'alamat_pelapor',   'label' => 'Alamat Pelapor',                         'type' => 'textarea', 'required' => true, 'rows' => 2],
            ['name' => 'no_telepon',       'label' => 'No. Telepon Pelapor',                    'type' => 'tel',      'required' => true, 'placeholder' => '08xxxxxxxxxx'],
            // Upload Dokumen
            ['name' => 'foto_ktp_almarhum', 'label' => 'Upload Fotocopy KTP Almarhum/Almarhumah',        'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf'],
            ['name' => 'foto_kk',           'label' => 'Upload Fotocopy KK',                              'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf'],
            ['name' => 'foto_ktp_pelapor',  'label' => 'Upload Fotocopy KTP Pelapor',                    'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf'],
            ['name' => 'surat_kematian_rs', 'label' => 'Upload Surat Keterangan Kematian dari RS/Dokter', 'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf'],
        ];
    ...
    public function nikah()
    {
        $fields = [
            // Data Calon Suami
            ['name' => 'nama_suami',         'label' => 'Nama Lengkap Calon Suami', 'type' => 'text',     'required' => true],
            ['name' => 'nik_suami',          'label' => 'NIK Calon Suami',          'type' => 'text',     'required' => true, 'maxLength' => 16],
            ['name' => 'tempat_lahir_suami', 'label' => 'Tempat Lahir',             'type' => 'text',     'required' => true],
            ['name' => 'tanggal_lahir_suami','label' => 'Tanggal Lahir',            'type' => 'date',     'required' => true],
            ['name' => 'pekerjaan_suami',    'label' => 'Pekerjaan',                'type' => 'text',     'required' => true],
            ['name' => 'alamat_suami',       'label' => 'Alamat Lengkap',           'type' => 'textarea', 'required' => true, 'rows' => 2],
            // Data Calon Istri
            ['name' => 'nama_istri',         'label' => 'Nama Lengkap Calon Istri', 'type' => 'text',     'required' => true],
            ['name' => 'nik_istri',          'label' => 'NIK Calon Istri',          'type' => 'text',     'required' => true, 'maxLength' => 16],
            ['name' => 'tempat_lahir_istri', 'label' => 'Tempat Lahir',             'type' => 'text',     'required' => true],
            ['name' => 'tanggal_lahir_istri','label' => 'Tanggal Lahir',            'type' => 'date',     'required' => true],
            ['name' => 'pekerjaan_istri',    'label' => 'Pekerjaan',                'type' => 'text',     'required' => true],
            ['name' => 'alamat_istri',       'label' => 'Alamat Lengkap',           'type' => 'textarea', 'required' => true, 'rows' => 2],
            // Info Pernikahan
            ['name' => 'tanggal_rencana_nikah', 'label' => 'Tanggal Rencana Pernikahan', 'type' => 'date', 'required' => true],
            ['name' => 'no_telepon',            'label' => 'No. Telepon',               'type' => 'tel',  'required' => true, 'placeholder' => '08xxxxxxxxxx'],
            // Upload Dokumen
            ['name' => 'foto_ktp_suami',      'label' => 'Upload Fotocopy KTP Calon Suami',              'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf'],
            ['name' => 'foto_ktp_istri',      'label' => 'Upload Fotocopy KTP Calon Istri',              'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf'],
            ['name' => 'foto_kk_suami',       'label' => 'Upload Fotocopy KK Calon Suami',               'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf'],
            ['name' => 'foto_kk_istri',       'label' => 'Upload Fotocopy KK Calon Istri',               'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf'],
            ['name' => 'pas_foto',            'label' => 'Upload Pas Foto 3x4 (4 lembar per orang)',      'type' => 'file', 'required' => true, 'accept' => 'image/*',    'multiple' => true],
            ['name' => 'foto_ijazah',         'label' => 'Upload Fotocopy Ijazah Terakhir (Keduanya)',    'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf','multiple' => true],
            ['name' => 'surat_belum_menikah', 'label' => 'Upload Surat Keterangan Belum Menikah',         'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf','multiple' => true],
        ];
    ...
    {
        $fields = [
            ['name' => 'nama_lengkap',  'label' => 'Nama Lengkap Penanggung Jawab', 'type' => 'text',     'required' => true],
            ['name' => 'nik',           'label' => 'NIK',                           'type' => 'text',     'required' => true, 'maxLength' => 16],
            ['name' => 'alamat',        'label' => 'Alamat Lengkap',               'type' => 'textarea', 'required' => true, 'rows' => 2],
            ['name' => 'no_telepon',    'label' => 'No. Telepon',                  'type' => 'tel',      'required' => true, 'placeholder' => '08xxxxxxxxxx'],
            ['name' => 'nama_kegiatan', 'label' => 'Nama Kegiatan',                'type' => 'text',     'required' => true],
            ['name' => 'jenis_kegiatan','label' => 'Jenis Kegiatan',               'type' => 'select',   'required' => true, 'options' => ['Sosial', 'Keagamaan', 'Olahraga', 'Budaya', 'Hiburan', 'Lainnya']],
            ...
            ['name' => 'waktu_kegiatan','label' => 'Waktu Kegiatan',               'type' => 'text',     'required' => true, 'placeholder' => 'Contoh: 08.00 - 17.00 WIB'],
            ['name' => 'lokasi_kegiatan','label' => 'Lokasi Kegiatan',             'type' => 'textarea', 'required' => true, 'placeholder' => 'Alamat lengkap lokasi kegiatan', 'rows' => 2],
            ['name' => 'jumlah_peserta','label' => 'Perkiraan Jumlah Peserta',     'type' => 'text',     'required' => true, 'placeholder' => 'Contoh: 100 orang'],
            ['name' => 'deskripsi_kegiatan','label' => 'Deskripsi Kegiatan',       'type' => 'textarea', 'required' => true, 'placeholder' => 'Jelaskan secara singkat kegiatan yang akan dilaksanakan', 'rows' => 4],
            ['name' => 'foto_ktp',         'label' => 'Upload Fotocopy KTP Penanggung Jawab',      'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf'],
            ['name' => 'proposal_kegiatan','label' => 'Upload Proposal Kegiatan',                  'type' => 'file', 'required' => true, 'accept' => '.pdf,.doc,.docx'],
            ['name' => 'surat_pernyataan', 'label' => 'Upload Surat Pernyataan Bertanggung Jawab', 'type' => 'file', 'required' => true, 'accept' => 'image/*,.pdf'],
        ];
    ...
    public function rekomendasi()
    {
        $fields = array_merge($this->getBaseFields(), [
            [
                ...
                'type'     => 'select',
                'required' => true,
                'options'  => ['Rekomendasi Kerja', 'Rekomendasi Pendidikan', 'Rekomendasi Bantuan', 'Rekomendasi Kredit/Pinjaman', 'Lainnya'],
            ],
            [
                'name'     => 'foto_ktp',
                'label'    => 'Upload Fotocopy KTP',
    ...
    public function submit(Request $request)
    {
        ...
        try {
            ...
            // Kumpulkan data form (non-file, non-meta)
            $formData = [];
