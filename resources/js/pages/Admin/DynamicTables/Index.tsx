...
export default function Index() {
    ...
    const pageProps = usePage<IndexPageProps>().props;
    ...
    const tablesArray = Array.isArray(tables?.data) ? tables.data : [];
                        ...
                        <div className="rounded-lg border bg-white shadow-sm">
                            <div className="py-12 text-center">
                                ...
                                <h3 className="mt-4 text-base font-medium text-gray-900 sm:text-lg">
                                    {searchTerm ? 'Tidak ada tabel yang sesuai' : 'Belum ada tabel'}
                                </h3>
