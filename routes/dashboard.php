...
// Semua route admin dijaga oleh middleware 'admin.only'
// → hanya role admin_bps dan admin_desa yang bisa masuk
// → pengguna_terdaftar akan diredirect ke halaman profil mereka
Route::middleware(['admin.only'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Kelola layanan settings (aktif/nonaktif)
...
// Redirect /dashboard → /admin/dashboard untuk kemudahan akses langsung dari URL
// Juga dijaga admin.only agar pengguna biasa tidak bisa masuk lewat sini
